...
**Branch:** `integrate/oke-and-pipelines` → merge to `main`  
**Integrates:** `feat/combined-pipelines` (tests, 3-tool MCP, code/issues pipelines) + `plan/cd-and-qwen-kserve` (OKE CD, KServe, runbooks)
